...
public class LessonsWindowController {
    ...
    @FXML
    private Button btnBack, btnBookIn;
    @FXML
    ...
    public void btnBookInHandler(ActionEvent e) {
        ...
        alert.setContentText("Are sure you want to to book this lesson?");
        ...
        if(result.get() == ButtonType.OK) {
            ...
            try {
                ...
                if(serverResponse.equals("bookin:failed")) {
                    Alert(Alert.AlertType.ERROR, "Book in status" ,"Book in failed!","Something went!");
                } else {
